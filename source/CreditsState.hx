...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - //bye bye color -lunar //rip color--rip bozo you wont be missed
		['Psych Engine Team'],
		...
		['gedehari',			'gedehari',			'Chart Editor\'s Sound Waveform base',				'https://twitter.com/gedehari'],
		['Keoiki',				'keoiki',			'Note Splash Animations',							'https://twitter.com/Keoiki_'],
		['SandPlanet',			'sandplanet',		'Mascot\'s Owner\nMain Supporter of the Engine',		'https://twitter.com/SandPlanetNG'],
		['bubba',				'bubba',		'Guest Composer for "Hot Dilf"',	'https://www.youtube.com/channel/UCxQTnLmv0OAS63yzk9pVfaw'],
		[''],
		["Funkin' Crew"],
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('coolphilshit')); // god like png
		add(bg);
	...
	override function update(elapsed:Float)
	{
		...
		if(controls.ACCEPT) {
			if(creditsStuff[curSelected][3] == '') return; //Hotfix -lunar
