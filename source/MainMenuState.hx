...
{
	public static var psychEngineVersion:String = 'oh lawd he comin'; //This is also used for Discord RPC
	...
	override function create()
	{
		...
		var bg:FlxSprite = new FlxSprite(-80).loadGraphic(Paths.image('coolphilshit'));
		...
		magenta = new FlxSprite(-80).loadGraphic(Paths.image('coolphilshit'));
